---
title: "Simulating how tree canopy and air conditioning may modify effects of wildfire on healthcare utilization: a locally tailored health-impact assessment"
...
#Sep 23, 2025: pay attention to folder
source(here("scripts","scripts-emm-no-conf-adj-old","read-wrangle-eff-estimates.R"))
emm_rd_per_iqr %>% 
  filter(var_type=="ses") %>% 
...
### RD x intervention vars and by other covariates

#### RD x intervention variables
##### RD x Tree canopy
...
##### RD x Impervious surfaces x rural-urban
...
##### RD x Impervious surfaces x biome
...
glm_rd_100k_quo_pt_imperv_prop_int_biome=glm(
  rd_100k_quo_pt~imperv_prop +biome_name_freq +
    biome_name_freq*imperv_prop,
  family = gaussian,
  na.action = "na.exclude", 
  weights = rd_quo_weight,
  data = wf_eff_emm_wide_no_outliers

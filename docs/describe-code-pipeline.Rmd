...
This document describes code that produces the results. The code files are located in the [scripts](https://github.com/michaeldgarber/climate-health/tree/main/scripts) folder of this repository: <https://github.com/michaeldgarber/climate-health/tree/main>. The three R scripts to run this analysis are the following:

...
URL of in-progress related Shiny app: https://michaeldgarber.shinyapps.io/climate-health-shiny/
...
Note that standard errors appear lower in metropolitan areas, such as the San Francisco Bay Area, Los Angeles, and San Diego.
```{r}
#| echo: false
#| warning: false
#| message: false

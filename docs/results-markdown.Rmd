...
### Distribution of target risk difference by scenario (histograms)
...
### Distribution of difference in risk differences
...
wf_ac_scenarios_all_pt %>% 
  ...
  theme_bw(base_size = 16)+
    labs(
    y="Number of ZCTAs",
    x="Difference in risk difference\nper 100,000",#line break
    fill="ZCTA intervened upon")
```

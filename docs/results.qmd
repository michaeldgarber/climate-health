...
## Uncertainty 
In each of 1,000 replicatess, re-sample **rd_baseline_pt** and **rd_per_ac_iqr_pt** from a normal distribution using the reported standard deviation and 95% CI (assuming confidence limit is 1.95*SD).

In each replicate, re-calculate **rd_target_pt** using these re-sampled values.
